/******************************************************************************
 * $Id: sysdep.h,v 1.1.1.1 2002/07/22 14:40:07 fang Exp $
 *   
 * File: sysdep.h
 *
 ...
 *   *** empty log message ***
 *
 *   Revision 1.4  2001/10/01 00:07:09  mud
 *   *** empty log message ***
 *
...
#include <fcntl.h>  /* Should be <sys/fcntl.h> */
#endif
...
#include "select.h"   Should be <sys/select.h> 
#endif  */
...
/* void srandom(unsigned long initial_seed); Conflict, had to comment out.
