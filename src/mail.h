/******************************************************************************
 * $Id: mail.h,v 1.1.1.1 2002/07/22 14:40:07 fang Exp $
 *   
 * File: mail.h
 *
...
#define STAMP_PRICE 1

/* Maximum size of mail in bytes (arbitrary)	*/
#define MAX_MAIL_SIZE 8096
 ...
 * Funcs
 */
extern void postmaster_send_mail(struct char_data * ch, struct char_data *mailman,int cmd, char *arg);
extern void postmaster_check_mail(struct char_data * ch, struct char_data *mailman,int cmd, char *arg);
extern void postmaster_receive_mail(struct char_data * ch, struct char_data *mailman,int cmd, char *arg);
