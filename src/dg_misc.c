         ...
         int type, char *cmd)
{
  ...
  script_log("dg_do_cast: cast/weave from dg_scripts not supported yet.");
  return;
  ...
  /* real cast code needed here. Use new code to check what targets
   * is required, if any for the spell, etc, etc, etc...
   */
  ...
  /* This is old crap magic code. Not in use anylonger. rewrite!
  ...
  */
  ...
  /*
    ...
    alog("do_dg_cast: Unsupported yet.");
